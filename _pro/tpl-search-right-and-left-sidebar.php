/*
 * Template Name: Search Left And Right Sidebar
 */
<?php get_header();?>

    <div id="content" class="span8 left-right-template">
		<div class="padder">
				...
				<?php while (have_posts()) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="post-content">
							...
							<p class="date"><?php the_time() ?> <em><?php _e( 'in', 'cc' ) ?> <?php the_category(', ') ?> <?php cc_author_link(); ?></em></p>
